...
export const phaseColor = (p) => ({ draft: 'bg-navy-50 text-navy-600', kra_open: 'bg-blue-100 text-blue-700', growth_planning: 'bg-teal-100 text-teal-700', mid_year_review: 'bg-indigo-100 text-indigo-700', self_appraisal: 'bg-cyan-100 text-cyan-700', manager_eval: 'bg-amber-100 text-amber-700', hod_eval: 'bg-orange-100 text-orange-700', calibration: 'bg-purple-100 text-purple-700', publish: 'bg-emerald-100 text-emerald-700', closed: 'bg-navy-100 text-navy-600', cancelled: 'bg-rose-100 text-rose-700' }[p] || 'bg-navy-50 text-navy-600');
